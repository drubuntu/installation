...
updatenodejs
apt  -y install gdebi-core mysql-server-5.5 server^ openssh-server^  lamp-server^ php-pear php5-dev php5-curl php5-json php5-gd git git-core ruby1.9.1-full libapache2-mod-php5 php5-mcrypt php5-gd php5-dev make build-essential nodejs-legacy  
}
