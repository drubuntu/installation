...
d8core=http://ftp.drupal.org/files/projects/drupal-8.0.0-beta9.tar.gz
d7core=http://ftp.drupal.org/files/projects/drupal-7.38.tar.gz
d6core=http://ftp.drupal.org/files/projects/drupal-6.36.tar.gz
