...
# welcom messages
heightfin="-"
wcmssg1="Willkommen zum zweiten Teil des Setups von Drubuntu!"
wcmssg2="Dieser Assistent erledigt alles für Sie." 
wcmssg3="Dies ist nur die Basisinstallation Funktionen fügen Sie später hinzu."
#standard messages
