...
ipmssg="Netzwerkadresse:"
nsmssg="Netzwerk:"
nmmssg="netzwerkmaske:"
bcmssg="Broadcast:"
secondipmssg="Die Adresse Ihres Host Only Adapters lautet"
usingvbmssg="Sie verwenden VirtualBox"
ipsetaremssg="Ihre Einstellungen lauten;"
ifwentwrongipmssg="Sollte etwas schiefgehen besuchen Sie bitte http://goo.gl/TodILj"
secondadaptermssg="Vergesen Sie nicht, einen Host-Only-Adapter hinzuzufügen."
ipeth0mssg="Dies ist die Adresse Ihres primären Netzwerkadapters:"
...
elementaryosswitch="--elementaryos"
faenzaswith="--faenza"
...
elementaryosmssg="ergänzt den Pantheon Desktop um zusätzliche Features."
faenzamsg="Istalliert das Faenza Icon Theme."
...
shortelementarymssg="Elementaryosfeatures"
shortfaenzamssg="Faenca Icon Theme"
...
entersubmssg="Geben Sie den Domainnamen Ihres Projektes ein (sub.domaain.tld)"
...
siteassistmssg="Mit diesem Assistenten können Sie ein zusätzliches Projekt für die gwünschte Drupalversion anlegen"
wvtumssg="Welche Version von Drupal möchten Sie verwenden?"
hostisactivemssg="Ihre neue domain ist nun aktiviert"
invoptionmssg="Option nicht verhanden"
#createsubdomain
