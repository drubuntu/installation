...
ifwentwrongipmssg="If something goes wrong visit: http://goo.gl/TodILj "
...
installationisfinished="Die Installation ist nun abgeschlossen"
chooseadesktopnow="Sie können nun einen Desktop wählen um diesen zu installieren"
...
pressspacetocontinue="Drücken Sie die Leertaste um fortzufahren"
quitdesktopsetup="Sie haben nicht die Leertaste gedrückt. Ihr System wird ohne desktop isntalliert"
